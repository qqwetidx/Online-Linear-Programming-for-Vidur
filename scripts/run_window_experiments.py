...
def main():
    ...
    parser.add_argument("--online-lp-max-waiting", type=int, default=512)
    ...
    if args.output_root:
        ...
        output_root = repo_root / "simulator_output" / f"window{args.time_limit}_r{args.num_replicas}_qps{int(args.qps)}_{timestamp}"
    ...
    for row in summary_rows:
        ...
        qpm = row.get("qpm")
        print(
            f"{algo}: completed={completed}/{total}, token_tps={token_tps}, qpm={qpm}"
        )
